...
class VideoQADataset(Dataset):
    def __init__(self, question_type, glovept_path, level, visual_s_path, visual_m_path, transform=None):
    ...
    def __getitem__(self, idx):
        ...
        return visual_s, visual_m, question, question_len, ans_candidates, ans_candidates_len, answer
